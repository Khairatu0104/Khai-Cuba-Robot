...
PM_START_TEXT = """
──「 [Tanya Degurechaff](https://telegra.ph/file/18cf34e913c3078321722.jpg) 」──
...
buttons = [
    [
        InlineKeyboardButton(
            text="> ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ <", url="t.me/Tanya?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="> About <", callback_data="layla_"),
        InlineKeyboardButton(
            text="> Group Support <", url=f"https://t.me/OdaSupport"
        ),
    ],
    [
        InlineKeyboardButton(text="> Anime Group <", url=f"https://t.me/Alterweebs"),
        InlineKeyboardButton(
...
*I'm Maintained By* @Llogvbiu 
Bug Report to @Alterweebs[.](https://telegra.ph/file/18cf34e913c3078321722.jpg)
...
TANYA_IMG = "https://telegra.ph/file/18cf34e913c3078321722.jpg"
...
def layla_about_callback(update, context):
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Tanya*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n❍ Rorerorerorero.
                 \n❍ Support Group @Alterweebs
                 \n❍ Assistant @Llogvbiu.
                 \nHere is the [Author](https://t.me/Llogvbiu).
                 \n\nIf you have any question about Tanya, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Ya Kenapa Si Bang")
        except Unauthorized:
            LOGGER.warning(
